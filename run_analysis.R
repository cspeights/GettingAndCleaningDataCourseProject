...
#set working directory to training data folder and download the training data
setwd("train")
...
#set working directory to test data folder and download the test data
setwd("../test")
...
#names(tidyData) <- c(names(meanStdevData[1:66]), "Subject", "Activity")
